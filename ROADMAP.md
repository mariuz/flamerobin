...
- [ ] **Long Identifier Names (63 chars)** — Update the UI (tree, DDL editor, all dialogs) to allow identifiers up to 63 characters; remove any hard-coded 31-character limits inherited from Firebird 2.x/3.x.
...
- [ ] **Version Detection Improvement** — Replace scattered hard-coded ODS comparisons with named constants (e.g., `ODS_FB4 = 13`, `ODS_FB5 = 13`, `ODS_FB6 = 14`) so version gates are readable and easy to update.
