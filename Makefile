...
ICC_PCH_USE_SWITCH = 
BK_DEPS = /home/mariuz/work/flamerobin/bk-deps
BK_MAKE_PCH = /home/mariuz/work/flamerobin/bk-make-pch
srcdir = .
...
RANLIB = ranlib
CXX = g++
CXXFLAGS = -g -O2 -DNDEBUG -std=c++11
CPPFLAGS =  -I/usr/lib/x86_64-linux-gnu/wx/include/gtk2-unicode-3.0 -I/usr/include/wx-3.0 -D_FILE_OFFSET_BITS=64 -DWXUSINGDLL -D__WXGTK__ -pthread  -pthread -DWX_PRECOMP
LDFLAGS =   -L/usr/lib/x86_64-linux-gnu -pthread   -lwx_gtk2u_aui-3.0 -lwx_gtk2u_stc-3.0 -lwx_gtk2u_xrc-3.0 -lwx_gtk2u_html-3.0 -lwx_gtk2u_qa-3.0 -lwx_gtk2u_adv-3.0 -lwx_gtk2u_core-3.0 -lwx_baseu_xml-3.0 -lwx_baseu_net-3.0 -lwx_baseu-3.0   -lboost_thread -lboost_system -pthread  -lboost_chrono
...
#CXXC = $(CXX)
CXXC = $(BK_DEPS) $(CXX)
__flamerobin___mac_setfilecmd = @true
#__flamerobin___mac_setfilecmd = \
#	$(SETFILE) -t APPL flamerobin$(EXEEXT)
#____flamerobin_WXDEBUG_p = -D__WXDEBUG__
#____flamerobin_WXDEBUG_p_2 = --define __WXDEBUG__
#____flamerobin_DEBUGFLAG_p = -D_DEBUG
#____flamerobin_DEBUGFLAG_p_2 = --define _DEBUG
...
#__flamerobin___os2_emxbindcmd = $(COND_PLATFORM_OS2_1___flamerobin___os2_emxbindcmd)
#__FR_PLATFORMSPECIFICSOURCES_OBJECTS \
...
__flamerobin_PCH_INC = -I./.pch/flamerobin
#__flamerobin_PCH_INC = $(ICC_PCH_USE_SWITCH) \
#	./.pch/flamerobin/wx/wxprec.h.gch
_____pch_flamerobin_wx_wxprec_h_gch___depname \
	= ./.pch/flamerobin/wx/wxprec.h.gch
#__IBPPPLATFORMDEFINE_p_2 = --define IBPP_DARWIN
__IBPPPLATFORMDEFINE_p_2 = --define IBPP_LINUX
#__IBPPPLATFORMDEFINE_p_2 = --define IBPP_WINDOWS
#__flamerobin___win32rc = flamerobin_flamerobin_rc.o
#__flamerobin_bundle___depname = flamerobin_bundle
#____flamerobin_BUNDLE_TGT_REF_DEP \
#	= FlameRobin.app/Contents/PkgInfo
__ibpp_PCH_INC = -I./.pch/ibpp
#__ibpp_PCH_INC = $(ICC_PCH_USE_SWITCH) \
#	./.pch/ibpp/_ibpp.h.gch
_____pch_ibpp__ibpp_h_gch___depname = \
	./.pch/ibpp/_ibpp.h.gch
#__IBPPPLATFORMDEFINE_p = -DIBPP_DARWIN
__IBPPPLATFORMDEFINE_p = -DIBPP_LINUX
#__IBPPPLATFORMDEFINE_p = -DIBPP_WINDOWS

### Targets: ###

all: revision-info flamerobin$(EXEEXT) $(__flamerobin_bundle___depname) $(LIBPREFIX)ibpp$(LIBEXT)
...
install: 
	...
	(cd $(srcdir)/docs ; $(INSTALL_DATA)  fr_license.html fr_whatsnew.html html.css $(DESTDIR)$(datadir)/flamerobin/docs)
	$(INSTALL_DIR) $(DESTDIR)${datarootdir}/man/man1
	(cd $(srcdir)/docs ; $(INSTALL_DATA)  flamerobin.1 $(DESTDIR)${datarootdir}/man/man1)
...
uninstall: 
	...
	(cd $(DESTDIR)${datarootdir}/man/man1 ; rm -f flamerobin.1)
...
revision-info: 
	cd $(srcdir) && ./update-revision-info.sh
...
./.pch/flamerobin/wx/wxprec.h.gch: 
	$(BK_MAKE_PCH) ./.pch/flamerobin/wx/wxprec.h.gch wx/wxprec.h $(CXX) $(FLAMEROBIN_CXXFLAGS)
...
#flamerobin_bundle: $(____flamerobin_BUNDLE_TGT_REF_DEP)
...
./.pch/ibpp/_ibpp.h.gch: 
	$(BK_MAKE_PCH) ./.pch/ibpp/_ibpp.h.gch _ibpp.h $(CXX) $(IBPP_CXXFLAGS)
...
flamerobin_InsertParametersDialog.o: $(srcdir)/src/gui/InsertParametersDialog.cpp $(FLAMEROBIN_ODEP)
	$(CXXC) -c -o $@ $(FLAMEROBIN_CXXFLAGS) $(srcdir)/src/gui/InsertParametersDialog.cpp
...
flamerobin_flamerobin_rc.o: $(srcdir)/res/flamerobin.rc $(FLAMEROBIN_ODEP)
	$(WINDRES) -i$< -o$@  --define HAVE_FRCONFIG_H $(____flamerobin_WXDEBUG_p_2) $(____flamerobin_DEBUGFLAG_p_2) $(__IBPPPLATFORMDEFINE_p_2) --include-dir . --include-dir $(srcdir)/src --include-dir $(srcdir)/src/ibpp --include-dir $(srcdir)/res  --include-dir /usr/lib/x86_64-linux-gnu/wx/include/gtk2-unicode-3.0 --include-dir /usr/include/wx-3.0
