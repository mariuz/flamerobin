...
// if code is regenerated by wxGlade, replace: styled_text_ctrl_sql = new wx...
// with a call to this function
void ExecuteSqlFrame::setupEditor()
{
    styled_text_ctrl_sql = new wxStyledTextCtrl(panel_splitter_top, ID_stc_sql);
    ...
    styled_text_ctrl_sql->StyleSetFont(wxSTC_STYLE_DEFAULT, font);
    styled_text_ctrl_sql->StyleClearAll();

    styled_text_ctrl_sql->StyleSetForeground(0,  wxColour(0x80, 0x00, 0x00));
    styled_text_ctrl_sql->StyleSetForeground(1,  wxColour(0x00, 0xa0, 0x00));		// multiline comment
    styled_text_ctrl_sql->StyleSetForeground(2,  wxColour(0x00, 0xa0, 0x00));		// one-line comment
    styled_text_ctrl_sql->StyleSetForeground(3,  wxColour(0x00, 0xff, 0x00));
    styled_text_ctrl_sql->StyleSetForeground(4,  wxColour(0x00, 0x00, 0xff));		// number
    styled_text_ctrl_sql->StyleSetForeground(5,  wxColour(0x00, 0x00, 0x7f));		// keyword
    styled_text_ctrl_sql->StyleSetForeground(6,  wxColour(0x00, 0x00, 0xff));		// 'single quotes'
    styled_text_ctrl_sql->StyleSetForeground(7,  wxColour(0xff, 0x00, 0xff));
    styled_text_ctrl_sql->StyleSetForeground(8,  wxColour(0x00, 0x7f, 0x7f));
    styled_text_ctrl_sql->StyleSetForeground(9,  wxColour(0xff, 0x00, 0x00));
    styled_text_ctrl_sql->StyleSetForeground(10, wxColour(0x00, 0x00, 0x00));		// ops
    styled_text_ctrl_sql->StyleSetForeground(11, wxColour(0x00, 0x00, 0x00));
    styled_text_ctrl_sql->StyleSetBackground(wxSTC_STYLE_BRACELIGHT, wxColour(0xff, 0xcc, 0x00));		// brace highlight
    styled_text_ctrl_sql->StyleSetBackground(wxSTC_STYLE_BRACEBAD, wxColour(0xff, 0x33, 0x33));		// brace bad highlight
    styled_text_ctrl_sql->StyleSetBold(5,  TRUE);
    styled_text_ctrl_sql->StyleSetBold(10, TRUE);
    styled_text_ctrl_sql->StyleSetBold(wxSTC_STYLE_BRACELIGHT, TRUE);
    styled_text_ctrl_sql->StyleSetBold(wxSTC_STYLE_BRACEBAD, TRUE);
	...
	styled_text_ctrl_sql->SetIndent(4);
	styled_text_ctrl_sql->SetUseTabs(false);
	styled_text_ctrl_sql->SetTabIndents(true);
	styled_text_ctrl_sql->SetBackSpaceUnIndents(true);
	styled_text_ctrl_sql->AutoCompSetIgnoreCase(true);
	styled_text_ctrl_sql->AutoCompSetAutoHide(true);

	// info in ScintillaDoc.html file (in scintilla source package)
	styled_text_ctrl_sql->SetMarginWidth(0, 40);		// turn on the linenumbers margin, set width to 40pixels
	styled_text_ctrl_sql->SetMarginWidth(1, 0);			// turn off the folding margin
	styled_text_ctrl_sql->SetMarginType(0, 1);			// set margin type to linenumbers
}
//-----------------------------------------------------------------------------
    ...
    BaseFrame(parent, id, title, pos, size, style), YxObserver()
{
    ...
    button_wrap = new wxButton(panel_contents, ID_button_wrap, _("Wrap"));
